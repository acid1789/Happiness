...
namespace Happiness
{
    public class Options
    {
        ...
        public Options(Happiness game)
        {
            ...
            m_AudioSlider = new UISlider(SoundManager.Inst.SoundVolume, 0.0f, 0.3f, new Rectangle(sliderLeft, top + marginTopBottom, sliderWidth, sliderHeight), Assets.SliderBar, Assets.SliderCursor, new Rectangle(0, 0, cursorWidth, cursorHeight), "Sound Volume", Assets.HelpFont);
            m_AudioSlider.OnChanged += OnSoundChanged;
            m_MusicSlider = new UISlider(SoundManager.Inst.MusicVolume, 0.0f, 0.5f, new Rectangle(sliderLeft, top + marginTopBottom + (sliderHeight * 3), sliderWidth, sliderHeight), Assets.SliderBar, Assets.SliderCursor, new Rectangle(0, 0, cursorWidth, cursorHeight), "Music Volume", Assets.HelpFont);
