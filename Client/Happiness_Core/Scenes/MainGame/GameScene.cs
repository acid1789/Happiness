...
namespace Happiness
{
    public class GameScene : Scene
    {
        ...
        public void LoadPuzzle()
        {
            ...
            {
                byte[] data = FileManager.Instance.ReadAllBytes(saveName);
        ...
        public override void Update(double deltaTime)
        {
            ...
            {
                DoEndScreenUpdate(deltaTime);
            }

            if (m_CoinsDialog != null)
                m_CoinsDialog.Update(deltaTime);
        }
        #endregion

        #region EndScreen
        void DoEndScreenUpdate(double deltaTime)
        {
